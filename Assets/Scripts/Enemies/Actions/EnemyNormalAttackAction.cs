...
namespace Resonance.Enemies.Actions
{
    ...
    /// </summary>
    public class EnemyNormalAttackAction : IEnemyAction
    {
        ...
        public void Start(EnemyController enemy)
        {
            ...
            Debug.Log("EnemyNormalAttackAction: Started attack action - will trigger animation");
        }
        ...
        {
            Debug.Log("EnemyNormalAttackAction: Attack action cancelled (e.g. by stun)");
